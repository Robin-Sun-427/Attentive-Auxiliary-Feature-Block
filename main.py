...
def main():
    ...
    train_sets = get_trainning_set(opt.upscale_factor)
    eval_sets  = get_eval_set(opt.upscale_factor)
    ...
    AAF_networks = AAF(num_channels=3,base_filter=opt.base_filter,num_stages=4,scale_factor=opt.upscale_factor)
    ...
    def checkpoint(epoch):
        model_out_path ='./model/model_1125_{}.pkl'.format(epoch)
